...
match loc:
    ...
    case 'Chitrakoot':
        print('This was the site of ‘Bharat Milap’ when Bharat informed Lord Rama of Dashratha’s demise and persuaded him to return to Ayodhya and claim his rightful throne. But when Lord Rama refused, Bharat took his slippers with him to Ayodhya to place it on the throne until Lord Ramas return to the kingdom.')
    ...
    case'Ashok Vatika':
        print('Ashok Vatika was a garden in Lanka, the Kingdom of demon king, Ravana. It was the location, where Sita was held captive after her abduction. It is speculated that she refused to stay in Ravanas palace, and preferred to stay under the Ashoka tree, hence the name Ashok Vatika')
